...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-md bg-white transition-all duration-500 ease-[cubic-bezier(0.76,0,0.24,1)] hover:-translate-y-2 hover:shadow-[0_24px_60px_rgb(20_34_62_/_0.12)]"
    >
      <div
